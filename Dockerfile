...
# helm,kubectl
COPY --from=kubetools /usr/local/bin/helm /usr/local/bin/helm
COPY --from=kubetools /usr/local/bin/kubectl /usr/local/bin/kubectl
COPY --from=kubetools /usr/local/bin/k3s /usr/local/bin/k3s
